...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A comprehensive stepper component for multi-step processes with compound component architecture and beautiful animations.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Basic: Story = {
  render: (args) => <StepperWithState steps={modernSteps} {...args} />,
  args: {
    variant: 'horizontal',
    size: 'md',
    showStepNumbers: true,
...
export const EcommerceCheckout: Story = {
  render: (args) => <StepperWithState steps={checkoutSteps} {...args} />,
  args: {
    variant: 'horizontal',
    size: 'md',
...
export const WithIcons: Story = {
  render: (args) => <StepperWithState steps={stepsWithIcons} {...args} />,
  args: {
...
export const WithErrorStates: Story = {
  render: (args) => <StepperWithState steps={stepsWithError} {...args} />,
  args: {
    currentStep: 1,
  },
}
...
function AsyncDataStoryComponent(args: any) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        <StepList />
        <Content />
        <Navigation onNext={handleNext} nextText={isLoading ? 'Processing...' : 'Next'} />
      </Stepper>
    </div>
  )
}
export const AsyncData: Story = {
  render: (args) => <AsyncDataStoryComponent {...args} />,
  args: {
    variant: 'horizontal',
  },
}
...
function CompoundComponentStory(args: any) {
  const [currentStep, setCurrentStep] = useState(0)
  return (
    <div className="max-w-4xl mx-auto">
      <Stepper
...
export const CompoundComponent: Story = {
  render: (args) => <CompoundComponentStory {...args} />,
  args: {
    variant: 'horizontal',
  },
}
...
function CustomRendersStory(args: any) {
  const [currentStep, setCurrentStep] = useState(0)
  ...
  const renderCustomContent = (step: StepperStep, index: number) => (
    <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl border border-blue-100">
      <h3 className="text-xl font-semibold text-gray-900 mb-4">Custom Content for {step.title}</h3>
...
export const CustomRenders: Story = {
  render: (args) => <CustomRendersStory {...args} />,
  args: {
    variant: 'horizontal',
    showStepNumbers: false,
  },
