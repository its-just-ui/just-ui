...
const meta: Meta<typeof Splitter> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible splitter component for resizable layouts',
      },
    },
  },
  argTypes: {
...
// Simple test story for dragging
export const DraggingTest: Story = {
  args: {
    direction: 'horizontal',
    initialSizes: [50, 50],
    className: 'h-64 w-full border border-gray-300 rounded-lg overflow-hidden',
  },
  render: (args) => (
    <div className="p-4">
      <h3 className="mb-4 text-lg font-semibold">
        Drag Test - Try dragging the handle between panels
      </h3>
      <Splitter {...args}>
        <Splitter.Pane index={0}>
          <div className="h-full bg-red-100 p-4 border-r border-gray-300">
            <h4 className="font-semibold text-red-800">Left Panel</h4>
            <p className="text-red-600 text-sm">Drag the handle to resize this panel</p>
          </div>
        </Splitter.Pane>
        <Splitter.Handle
          index={0}
        ...
        <Splitter.Pane index={1}>
          <div className="h-full bg-blue-100 p-4">
            <h4 className="font-semibold text-blue-800">Right Panel</h4>
            <p className="text-blue-600 text-sm">This panel will resize when you drag the handle</p>
          </div>
        </Splitter.Pane>
      </Splitter>
    </div>
...
// Simple inline test story
export const InlineTest: Story = {
  args: {
    direction: 'horizontal',
    initialSizes: [50, 50],
  },
    ...
    >
      ...
      >
        <Splitter.Pane index={0}>
          ...
          >
            <h3 style={{ margin: '0 0 10px 0', color: '#c62828' }}>Left Panel</h3>
            <p style={{ margin: 0, color: '#d32f2f' }}>Drag the handle to resize</p>
          </div>
        </Splitter.Pane>
        <Splitter.Handle
          index={0}
        ...
        <Splitter.Pane index={1}>
          ...
          >
            <h3 style={{ margin: '0 0 10px 0', color: '#2e7d32' }}>Right Panel</h3>
            <p style={{ margin: 0, color: '#388e3c' }}>This panel will resize</p>
          </div>
        </Splitter.Pane>
      </Splitter>
    </div>
...
// Simple debug story for testing resize
export const DebugResize: Story = {
  args: {
    direction: 'horizontal',
    initialSizes: [50, 50],
  },
  ...
  render: (args) => (
    <div style={{ width: '600px', height: '400px', border: '1px solid black' }}>
      <Splitter {...args}>
        ...
        <Splitter.Handle index={0} />
        <Splitter.Pane index={1}>
          <div style={{ backgroundColor: 'lightgreen', height: '100%', padding: '10px' }}>
            Right Panel
          </div>
        </Splitter.Pane>
      </Splitter>
